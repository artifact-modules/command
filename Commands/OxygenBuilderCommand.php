...
namespace AncientWorks\Artifact\Modules\Command\Commands;

use OXYGEN_VSB_Signature;
use WP_CLI;
use WP_CLI_Command;
use WP_Query;

/**
 * Oxygen Builder Command
 */
class OxygenBuilderCommand extends WP_CLI_Command
{
    /**
     * Shortcode Signing.
     *
     ...
     */
    public function sign_shortcode($args, $assoc_args)
    {
